...
position = names.index("Daphne") # .index() returns position
print(position)
...
position1 = names.index("Charlie")
print(scores[position1])
# Q9
# Ask the user to enter a student name.
...
if studentname in names:
    studentscore = names.index(studentname)
    print(scores[studentscore])
else:
    print("Student not found")
# Q10
