...
# Welcome Alicia
# Class: 3E1
def print_name_tag(name, class_name): #parameter
...
# ________________________________________
# 18-04
# 18 days + 3 months (3 * 30) = 90 + 18 = 108

# 09-08
# 9days + 7 months (7*30) = 210 + 9 = 219
...
def calculate_days(date):
    day = date[:2]
    month = date[3:5]
    return int(day) + (int(month)-1)*30
# calculate_days("01-02")
