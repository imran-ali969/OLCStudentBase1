...
leaf_width = float(input("Enter the width: "))
shortest_distance = 99999
predicted_type = ""

for i in plant_records: # i is the key
    plant = plant_records[i] ## retrieving value [8.2, 3.1, 'Herb']
    existing_length = plant[0]
    existing_width = plant[1]
    plant_type = plant[2]
    dist = math.sqrt((leaf_length - existing_length) **2 + (leaf_width - existing_width)**2)
