...
for names in attendance:
    if attendance[names] >= 90 and scores[names] >= 85:
        star_attendance.append(names)
print(star_attendance)
for names in star_attendance:
    print(f"Congratulations {names}! With an attendance of {attendance[names]} and a score of {scores[names]}, you are awarded the Star Student Award!")
